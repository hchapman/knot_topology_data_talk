...
var Reveald3 = window.Reveald3 || (function(){
    ...
    Reveal.addEventListener('ready', function( event ) {
        loadSlideVisualizations(event);
    });

    Reveal.addEventListener('slideloaded', function( event ) {
        loadSlideVisualizations(event);
    });

    Reveal.addEventListener('slideunloaded', function( event ) {
        ...
        let previousSlide = event.currentSlide;
        let allIframes = [];
        if (previousSlide){
    ...
    function loadSlideVisualizations(event){
